package cat.itacademy.barcelonactiva.llombartroma.toni.s04.t01.n0.S04T01N01LlombarRomaToni.controllers;
...
public class HelloWorldController {
    ...
    public String greeting(@RequestParam(name="name",defaultValue = "UNKNOWN") String name) {
        return "Hi there, " +name+ ". You're executing a Maven project.";
    }
    /* greeting2 method */
    ...
    public String greeting2(@PathVariable(required = false) String name) {
        if(name!=null) {
            ...
            return "Hi there, UNKNOWN. You're executing a Maven project.";
        }
    }
}
